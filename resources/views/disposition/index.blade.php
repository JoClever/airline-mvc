<x-layout>
    <div class="max-w-6xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-gray-600 text-lg">Manage flight disposition</p>
        </div>
    </div>
    ...
    <div class="card w-sm bg-base-200 card-lg shadow-sm m-auto">
        <div class="card-body items-center text-center">
            ...
            <div class="card-actions justify-end flex-col items-center">
                <a href="{{ route('disposition.flights.index') }}" class="btn btn-primary">Flights</a>
                <a href="{{ route('disposition.crews.index') }}" class="btn btn-secondary">Crews</a>
            </div>
        </div>
    </div>
</x-layout>
