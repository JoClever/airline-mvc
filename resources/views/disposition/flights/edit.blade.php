<x-layout>
    <div class="max-w-xl mx-auto">
        <div class="mb-8">
            <h1 class="text-4xl font-bold mb-2">Edit Flight {{ $flight->flight_number }} {{ $flight->formatted_departure_date }} Disposition</h1>
            <p class="text-gray-600">Update crew assignments for this flight</p>
        </div>
        ...
        <form method="POST" action="{{ route('disposition.flights.update', ['flight' => $flight->id]) }}" class="card bg-base-100 shadow-lg m-auto">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                ...
                <fieldset class="mt-4">
                    ...
                    <div class="space-y-4 mt-4">
                        <div class="form-control">
                            ...
                            <input type="text" id="crew_id" name="crew_id" placeholder="Enter crew ID" class="input input-bordered w-full @error('crew_id') input-error @enderror" value="{{ old('crew_id', $flight->crew_id ?? '') }}" required>
                            @error('crew_id')
                                <label class="label">
                ...
                <div class="card-actions justify-between pt-4">
                    <a href="{{ route('disposition.flights.show', $flight) }}" class="btn btn-outline">Cancel</a>
