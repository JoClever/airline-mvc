<x-layout>
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <!-- Filters Section -->
        <form method="GET" action="{{ route('disposition.flights.index') }}" class="card bg-base-200 card-border shadow-lg">
            <div class="card-body">
                <fieldset>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                        <div class="form-control">
                            ...
                            <input type="text" name="flight_number" id="flight_number"
                                value="{{ request('flight_number') }}" placeholder="e.g., AA123"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="departure_airport" id="departure_airport"
                                value="{{ request('departure_airport') }}" placeholder="e.g., KJFK"
                                class="input input-bordered w-full">
                        </div>
                        <div class="form-control">
                            ...
                            <input type="text" name="arrival_airport" id="arrival_airport"
                                value="{{ request('arrival_airport') }}" placeholder="e.g., EGLL"
                                class="input input-bordered w-full">
                        </div>
                        <div class="form-control">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="month" id="month" value="{{ request('month') }}"
                                placeholder="e.g., 2026-01" class="input input-bordered w-full">
                        </div>
                        <div class="form-control">
                            <label class="label" for="year">
                                <span class="label-text">Crew</span>
                            </label>
                            <input type="text" name="crew_id" id="crew_id" value="{{ request('crew_id') }}"
                                placeholder="e.g., 42" class="input input-bordered w-full">
                        </div>
                        <div class="flex gap-2 items-end col-span-1 sm:col-span-2 md:col-span-3">
                            ...
                            <a href="{{ route('disposition.flights.index') }}" class="btn btn-outline flex-1">Clear
                                Filters</a>
                        </div>
                    </div>
                </fieldset>
