        ...
        <form class="card bg-base-100 shadow-lg m-auto">
            <div class="card-body">
                ...
                <div class="card-actions justify-between pt-4">
                    <a href="{{ route('planner.flights.index') }}" class="btn btn-outline">Back to List</a>
                    <div class="flex gap-2">
                        <a href="{{ route('planner.flights.edit', $flight) }}" class="btn btn-warning">Edit Flight</a>
                        <form method="POST" action="{{ route('planner.flights.destroy', $flight) }}" class="m-0">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-error" onclick="return confirm('Are you sure you want to delete this flight?')">Delete Flight</button>
                        </form>
                    </div>
                </div>
            </div>
